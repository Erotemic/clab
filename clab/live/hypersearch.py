...
def opt_crf():
    from .torch.urban_mapper import get_snapshot, urban_mapper_eval_dataset, PredictHarness  # NOQA
    from .torch.sseg_train import task_datasets, get_task, SSegInputsWrapper  # NOQA
